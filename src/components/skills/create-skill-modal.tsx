...
} from "@/validators/create-skill-schema";

type CreateSkillModalProps = {
    skill?: UserSkill;
    onClose: () => void;
    onSave: (data: CreateSkillFormData) => Promise<void>;
};
    ...
    return (
        ...
        >
            <form
                role="dialog"
                aria-modal="true"
                aria-label={isEditing ? "Editar Skill" : "Criar Skill"}
            ...
            >
                <div className="text-[17px] font-bold text-[var(--foreground)]">
                    {isEditing ? "Editar Skill" : "Criar Skill"}
                </div>

                <div className="flex flex-col gap-1.5">
                    <Label
                        htmlFor="create-skill-imgUrl"
                        className="text-[13px] text-[var(--muted-foreground)]"
                    >
                        URL da imagem
                    </Label>
                    <Input
                        id="create-skill-imgUrl"
                        type="text"
                        placeholder="https://..."
                        aria-invalid={!!errors.imgUrl}
                        aria-describedby="create-skill-imgUrl-message"
                    ...
                    {errors.imgUrl && (
                        <p
                            id="create-skill-imgUrl-message"
                ...
                <div className="flex flex-col gap-1.5">
                    <Label
                        htmlFor="create-skill-nome"
                        className="text-[13px] text-[var(--muted-foreground)]"
                    >
                        Nome da skill
                    </Label>
                    <Input
                        id="create-skill-nome"
                        type="text"
                        placeholder="Digite o nome da skill"
                        aria-invalid={!!errors.nome}
                        aria-describedby="create-skill-nome-message"
                        className="h-11 rounded-[9px] border-[var(--border)] bg-[var(--input-bg-nested)] text-sm text-[var(--foreground)] focus-visible:border-[var(--primary)] focus-visible:ring-[var(--primary)]/30"
                        {...register("nome")}
                    />
                    {errors.nome && (
                        <p
                            id="create-skill-nome-message"
                            className="text-xs text-[var(--destructive)]"
                        >
                            {errors.nome.message}
                        </p>
                ...
                <div className="flex flex-col gap-1.5">
                    <Label
                        htmlFor="create-skill-descricao"
                        className="text-[13px] text-[var(--muted-foreground)]"
                    >
                        Descrição
                    </Label>
                    <Textarea
                        id="create-skill-descricao"
                        placeholder="Descreva a skill"
                        aria-invalid={!!errors.descricao}
                        aria-describedby="create-skill-descricao-message"
                        className="rounded-[9px] border-[var(--border)] bg-[var(--input-bg-nested)] text-sm text-[var(--foreground)] focus-visible:border-[var(--primary)] focus-visible:ring-[var(--primary)]/30"
                        {...register("descricao")}
                    />
                    {errors.descricao && (
                        <p
                            id="create-skill-descricao-message"
                            className="text-xs text-[var(--destructive)]"
                        >
                ...
                <div className="flex flex-col gap-1.5">
                    <Label
                        htmlFor="create-skill-level"
                        className="text-[13px] text-[var(--muted-foreground)]"
                    >
                        Level
                    </Label>
                    <Input
                        id="create-skill-level"
                        type="number"
                        min={1}
                        max={5}
                        aria-invalid={!!errors.level}
                        aria-describedby="create-skill-level-message"
                        className="h-11 rounded-[9px] border-[var(--border)] bg-[var(--input-bg-nested)] text-sm text-[var(--foreground)] focus-visible:border-[var(--primary)] focus-visible:ring-[var(--primary)]/30"
                        {...register("level", { valueAsNumber: true })}
                    />
                    {errors.level && (
                        <p
                            id="create-skill-level-message"
                            className="text-xs text-[var(--destructive)]"
                        >
